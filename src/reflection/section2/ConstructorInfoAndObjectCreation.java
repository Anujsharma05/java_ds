...
/**
 * getDeclaredConstructors: return all declared constructors
...
//        printConstructorData(Person.class);
     ...
     */
    private static <T> T createInstanceWithArguments(Class<T> clazz, Object... args) throws InvocationTargetException, InstantiationException, IllegalAccessException {
